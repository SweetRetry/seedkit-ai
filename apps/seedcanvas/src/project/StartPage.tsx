...
function CoverPlaceholder({ id }: { id: string }) {
  // Unique pattern ID to avoid SVG conflicts when multiple cards render
...
export function StartPage() {
  ...
  return (
    <div className="flex h-full w-full items-start justify-center overflow-y-auto bg-background">
      <div className="w-full container px-10 py-16 flex flex-col gap-12">
        {/* ── Hero ── */}
        <motion.header
          ...
          transition={{ duration: 0.4, ease }}
        >
          <h1 className="text-4xl font-bold tracking-tight">SeedCanvas</h1>
          <p className="text-base text-muted-foreground">AI-powered infinite canvas</p>
        </motion.header>
